...
const hiImageContainer = document.querySelector(".hiImageContainer")
const nameTag = document.querySelector(".nameTag")
const jobTitleContainers = document.querySelectorAll(".jobContainer")
...
window.addEventListener("scroll", () => {
    ...
    hiText.style.transform = `translateY(${offsetY * 0.1}px)`
    hiImageContainer.style.transform = `translate(${offsetY * 0.4}px , ${offsetY * 0.7}px)`
    nameTag.style.transform = `translateX(${offsetY * 0.1}px)`
